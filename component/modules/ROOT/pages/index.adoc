...
FlashLex is an internet gateway for the internet of things. It simplifies accessing tour IOT device by providing a simple HTTP REST API to dispatch messages.
